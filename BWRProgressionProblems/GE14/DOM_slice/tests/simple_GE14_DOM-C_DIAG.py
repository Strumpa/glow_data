...
assembly_id = "GE14_DOM-C" # Identifier for the assembly configuration (e.g., "GE14_DOM")
...
GE14_OUTPUT = GLOW_DATA / "starterDD_outputs" / "GE14" / assembly_id / "2L_scheme" / "DIAG_FULL_TESTS"
...
GE14_assembly = DragonCase(
        ...
        config_yamls={
            ...
            "GEOM": str(GE14_DOM_INPUTS / f"simple_GEOM_{case_name_suffix}.yaml"),
            "CALC_SCHEME": str(GE14_DOM_INPUTS / f"CALC_SCHEME.yaml"),
        },
