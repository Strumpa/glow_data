...
def split_box_in_MACROs_for_IC(assembly_box_cell, pincell_pitch, assembly_pitch, control_cross_thickness, control_cross_half_span):
    ...
    list_of_materials = ["COOLANT","COOLANT","COOLANT","COOLANT", "COOLANT", "COOLANT", "COOLANT", "COOLANT", "COOLANT", "COOLANT", "COOLANT", "COOLANT",] \
        ...
        + ["MODERATOR"]*8 + [sheath_material]*2 + ["MODERATOR"]*6 + ["CHANNEL_BOX"]*4 + [sheath_material]*2 + ["CHANNEL_BOX"]*4 + ["MODERATOR"]*4 \
        + [sheath_material]
    ...
    list_of_macros = ["BCELL1", "BCELL2","BCELL3","BCELL4",] + ["LSIDE0", "LSIDE1", "BSIDE0", "BSIDE1", "TSIDE0", "TSIDE1","RSIDE0", "RSIDE1"]  \
        ...
        + ["WCROSS", "NCROSS","WCROSS", "NCROSS", "WCROSS", "NCROSS", "WCROSS", "NCROSS",] + ["BCELL2", "BCELL1","BCELL4","BCELL3",]  \
    ...
    assembly_box_cell.set_properties({
        PropertyType.MATERIAL: list_of_materials,# + ["mat0"] + ["mat"] * (47 - len(list_of_materials)),
        PropertyType.MACRO: list_of_macros# +  ["macro0"] + ["macro1"] * (47 - len(list_of_macros))
    })
...
### Build geometry for control cross structure without absorber tubes first : check tracking possibility for TISO option.
assembly_box_cell_face = make_partition(
    [assembly_box_cell.face],
...
analyse_and_generate_tdt(
    [lattice],
    f"data/glow_data/tdt_data/GE14_simple_control_cross_rounded_struct",
    TdtSetup(
