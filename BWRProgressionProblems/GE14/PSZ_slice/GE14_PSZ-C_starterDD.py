...
assembly_id = "GE14_PSZ-C" # Identifier for the assembly configuration (e.g., "GE14_PSZ", "GE14_DOM", "GE14_VAN")
...
GE14_assembly = DragonCase(
        ...
        config_yamls={
            ...
            "GEOM": str(GE14_PSZ_INPUTS / f"GEOM_{case_name_suffix}.yaml"),
            "CALC_SCHEME": str(GE14_PSZ_INPUTS / f"CALC_SCHEME_{scheme_suffix}_{macro_grouping}.yaml"),
        },
...
if export_serpent2:
    ...
    path_to_yaml_geometry = GE14_PSZ_INPUTS / f"GEOM_{case_name_suffix}.yaml"
