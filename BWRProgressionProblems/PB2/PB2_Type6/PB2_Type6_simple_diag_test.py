...
assembly_id = "PB2_Type6" # Identifier for the assembly configuration (e.g., "PB2_Type6")
nuclear_data_library = "endfb8r1"  # Options: "endfb8r1", "jeff311"


calculation_scheme = "CALC_SCHEME_2L_mix_splitting"
case_name_suffix = "DIAG" # "DIAG" # "FULL"
...
PB2_OUTPUT = GLOW_DATA / "starterDD_outputs" / "PB2" / assembly_id / "2L_scheme" / case_name_suffix
...
PB2_assembly = DragonCase(
        ...
        config_yamls={
            ...
            "GEOM": str(PB2_TYPE6_INPUTS / f"GEOM_{case_name_suffix}.yaml"),
