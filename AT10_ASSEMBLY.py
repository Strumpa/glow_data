...
lattice.add_cell(water_square, ((9/2)*pitch, (9/2)*pitch, 0.0))
lattice.add_cell(water_square, ((11/2)*pitch, (9/2)*pitch, 0.0))
lattice.add_cell(water_square, ((13/2)*pitch, (9/2)*pitch, 0.0))
...
lattice.add_cell(water_square, ((9/2)*pitch, (11/2)*pitch, 0.0))
lattice.add_cell(water_square, ((11/2)*pitch, (11/2)*pitch, 0.0))
lattice.add_cell(water_square, ((13/2)*pitch, (11/2)*pitch, 0.0))
...
lattice.add_cell(water_square, ((9/2)*pitch, (13/2)*pitch, 0.0))
lattice.add_cell(water_square, ((11/2)*pitch, (13/2)*pitch, 0.0))
lattice.add_cell(water_square, ((13/2)*pitch, (13/2)*pitch, 0.0))
...
if tracking_type == "TISO":
    ...
    [lattice], "data/tdt_data/AT10_lattice_TISO", TdtSetup(GeometryType.TECHNOLOGICAL, 
