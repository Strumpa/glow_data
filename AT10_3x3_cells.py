...
if tracking_type == "TISO":
      ...
      [lattice], "data/glow_data/tdt_data/AT10_3x3_cells_TISO", TdtSetup(GeometryType.SECTORIZED, 
      ...
      analyse_and_generate_tdt(
      [lattice], "data/glow_data/tdt_data/AT10_3x3_cells_TSPC", TdtSetup(GeometryType.SECTORIZED, 
                                                            property_types=[PropertyType.MATERIAL],
