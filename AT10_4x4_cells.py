...
if tracking_type == "TISO":
    ...
    [lattice], "data/tdt_data/AT10_4x4_cells_TISO", TdtSetup(GeometryType.TECHNOLOGICAL, 
    ...
    analyse_and_generate_tdt(
    [lattice], "data/tdt_data/AT10_4x4_cells_TSPC", TdtSetup(GeometryType.SECTORIZED, 
                                                            property_type=PropertyType.MATERIAL,
