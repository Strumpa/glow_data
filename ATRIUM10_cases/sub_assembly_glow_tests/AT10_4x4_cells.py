...
lattice = Lattice([cell1], 'ATRIUM-10 4x4', center=(0.0, 0.0, 0.0))
...
if tracking_type == "TISO":
    ...
    [lattice], "data/glow_data/tdt_data/AT10_4x4_cells_TISO", TdtSetup(GeometryType.TECHNOLOGICAL, 
    ...
    analyse_and_generate_tdt(
    [lattice], "data/glow_data/tdt_data/AT10_4x4_cells_TSPC", TdtSetup(GeometryType.SECTORIZED, 
                                                            property_types=[PropertyType.MATERIAL],
